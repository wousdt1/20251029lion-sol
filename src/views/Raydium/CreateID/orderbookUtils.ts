...
export const EVENT_QUEUE_LENGTH_MIDDLE = 1400;
export const EVENT_QUEUE_LENGTH_MINI = 128;
...
export const REQUEST_QUEUE_LENGTH_MIDDLE = 63;
export const REQUEST_QUEUE_LENGTH_MINI = 9;
export const REQUEST_SIZE = 80;
export const REQUEST_QUEUE_HEADER_SIZE = 32;

export const ORDERBOOK_LENGTH = 909;
export const ORDERBOOK_LENGTH_MIDDLE = 450;
export const ORDERBOOK_LENGTH_MINI = 201;
