          ...
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              ...
              <button className="secondary-button">
                <a href="https://www.youtube.com/liontoolcc" target="_blank" rel="noreferrer" title='视频教程'>
                  观看演示视频
                </a>
              </button>
            </div>
          ...
          <div className="footer-content">
            <div className="footer-about">
              ...
              <div className="social-links">
                ...
                <a href="https://github.com/liontoolcc" className="social-icon" target="_blank" rel="noreferrer">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="#1676fc">
            ...
            <div className="footer-links">
              ...
              <ul>
                ...
                <li><a href="https://www.youtube.com/liontoolcc" target="_blank" rel="noreferrer" title='视频教程'>视频教程</a></li>
